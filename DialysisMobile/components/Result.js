...
const Result = (props) => {
  ...
  const badgeStyle =
    sepsisStatus === "Condition Number 1"
      ? styles.warningBadge
      : styles.dangerBadge;
  const tableHead = [
    "Group",
  ...
  const tableData = [
    [
      ...
      props.route.params.PulmonaryDisease,
      props.route.params.Diabetes,
      props.route.params.ImmunosuppressiveTherapy,
      props.route.params.CVD,
      props.route.params.SerumCreatinine,
      props.route.params.UreaNitrogene,
      props.route.params.eGFR,
      props.route.params.WhiteBloodCells,
      props.route.params.Hemoglobin,
      props.route.params.Platelet,
    ...
    <ScrollView style={styles.scroll}>
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => props.navigation.navigate("Sepsis")}
        >
